...
1. A Person is uniquely identified by their Name. (Normalized name in Person table and check in CreatePerson)
1. A Person who has not had an astronaut assignment will not have Astronaut records. (Order of Create Astronaut )
